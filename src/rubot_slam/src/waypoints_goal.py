...
def movebase_client():
    ...
    goal_pose1 = create_pose_stamped(6, 2.6, radians(90))
    goal_pose2 = create_pose_stamped(4.7, 0.88, radians(90))
    goal_pose3 = create_pose_stamped(3.37, 4, radians(90))
    goal_pose4 = create_pose_stamped(2.2, 0.9, radians(90))
    goal_pose5 = create_pose_stamped(0.8, 3.9, radians(90))

    # --- Follow Waypoints ---
    waypoints = [goal_pose1,goal_pose2,goal_pose3,goal_pose4,goal_pose5]
    for wp in waypoints:
        client.send_goal(wp)
        wait = client.wait_for_result(rospy.Duration(100))
        if not wait:
